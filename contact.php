...
<head>
    ...
    <title>Inmobiliaria | San carlos</title>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-text">
                        <h2 style="background: #dfa974; color: #ffffffba; border-radius: 2px;">Vision </h2>
                ...
                <div class="col-lg-6 ">
                  <div class="contact-text">
                      <h2 style="background: #dfa974; color: #ffffffba; border-radius: 2px;" >Mision</h2>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                          labore et dolore magna aliqua.
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                ...
                <div class="row  ">
                  ...
                  <div class="col-lg-4 ">
                    <div class="contact-text">
                        ...
                        <h2 style="color: #d0a071b0;">Ubicacion</h2>
                        <p>.</p>
