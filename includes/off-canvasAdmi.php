    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="mainmenu mobile-menu">
            <ul>
              ...
              <li><a href="./rooms.html">control de propiedades</a></li>
              <li><a href="./about-us.html">control de usuarios</a></li>
              <li><a href="./blog.html">Editar Blog</a></li>
            </ul>
        </nav>
        ...
        <ul class="top-widget">
            <li><i class="fa fa-phone"></i> (622) 1424836 || (622) 2261735</li>
            <li><i class="fa fa-envelope"></i> da.design@hotmail.es</li>
        </ul>
    </div>
