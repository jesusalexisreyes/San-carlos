...
CREATE TABLE `propiedad` (
  ...
  `baño` int(40) NOT NULL,
  `tipo` varchar(45) NOT NULL,
  `disponibilidad` tinyint(4) NOT NULL,
  `imagenes` varchar(10000) NOT NULL,
  `descripcion` varchar(105) NOT NULL,
  `costo_dia` double NOT NULL,
  `costo_semana` double NOT NULL,
  `costo_mes` double NOT NULL,
  `latitud` varchar(105) NOT NULL,
  `longitud` varchar(105) NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-02-21 18:03:01
